<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ValidateRIF.aspx.cs" Inherits="FiscalInfoWebService.UI.ValidateRIFTest" MaintainScrollPositionOnPostback="true" %>
...
<body>
    ...
    <form id="form1" style="margin-top: 10px" runat="server">
        ...
        <fieldset>
            ...
            <legend><strong>ValidateRIF</strong></legend>

            <em>Verifys if a RIF is valid</em>
            ...
            <div style="text-align: center">
                <asp:Button ID="SubmitButton" runat="server" Text="Validate" Font-Bold="true" OnClick="SubmitButton_Click" />
            </div>
